...
- (void) awakeFromNib
{
    NSArray *tags = [NSArray arrayWithObjects:  @" Name", @"Artist", @"Album Artist", @"Album", @"Grouping", @"Composer", @"Comments", @"Genre", @"Date", @"Track #", @"Disk #", @"TV Show", @"TV Episode", @"TV Network", @"TV Episode ID", @"TV Season", @"TV Episode", @"Genre", @"Description" , @"Long Description", @"Copyright", @"Encoding Tool", @"Encoded By", @"cnID", nil];
    id tag;
    for (tag in tags)
